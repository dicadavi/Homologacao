    ...
    return (
        <>
            <CCard>
                ...
                {isFetching && <CAlert  color="primary" className="d-flex align-items-center"><CSpinner component="span" size="sm" aria-hidden="true" color='grey' /><div>&nbsp;Carregando... </div> </CAlert>}
                ...
                {salesVolks && viewType === 'Dados Detalhado' ? <CCardBody style={{ marginLeft: '0px' }}> <NewDataBla dados={salesVolks} coluna={coluna} /></CCardBody> : ""}
                <CCardBody>
